...
## ⚪︎**開発のきっかけ
学生時代の経験から「自分に合った単語を効率よく覚える方法」を見つけることに苦労していました。特に感じていた課題は、単語を覚えるだけで、後から見返すさないというものです。また、学んだ単語が増えるにつれて整理ができなくなり、単語帳使用が疎遠になることが多々ありました。そのため、自分だけの“語彙の本棚”のようなものがあればと考えるようになりました。
...
| ログイン画面                                                                                                  | サインイン画面                                                                                                  |
| ----------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| ![Login画面](img width="1452" alt="Image" src="https://github.com/user-attachments/assets/c4430d06-5508-4bc8-83ae-9e98b06103f3") | ![Signin画面](img width="1451" alt="Image" src="https://github.com/user-attachments/assets/b64d22a3-b9b8-4294-af12-0c7bffca7ba2") |
| ログイン後サイトの所定の画面に遷移できる様になっています。                                    | 情報を登録後、所定の画面に遷移できる様になっています。       |

| My page画面                                                                                                  | Bookshelf画面                                                                                                  |
| ----------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| ![Mypage画面](img width="1450" alt="Image" src="https://github.com/user-attachments/assets/76553a0b-3c3f-4a20-bcb7-67ddc5c13f4f") | ![Bookshelf画面](img width="1451" alt="Image" src="https://github.com/user-attachments/assets/f0c73909-f5a8-4005-9c0b-2e8b9f4fe5d4") |
| 自分のアカウント情報の編集やフォロー申請、フレンド一覧、学習記録が確認できる様になっています。                                    | 「＋」ボタンでカテゴリーを作成し、単語一覧に遷移できる様になっています。       |

| Bookshelf 単語一覧画面                                                                                                  | Bookshelf 単語詳細画面                                                                                                  |
| ----------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| ![単語一覧画](img width="1455" alt="Image" src="https://github.com/user-attachments/assets/285886f9-01b8-4933-ba7e-5bc727eab252") | ![単語詳細画面](img width="1454" alt="Image" src="https://github.com/user-attachments/assets/010ba713-4cdc-4568-ac13-66a7e4c3e781") |
...
| Study画面                                                                                                  | Study詳細画面                                                                                                  |
| ----------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| ![Study画面](img width="1454" alt="Image" src="https://github.com/user-attachments/assets/b72ba954-2a6f-4867-a1da-10a470def8b0") | ![Study詳細画面](img width="1453" alt="Image" src="https://github.com/user-attachments/assets/8d16fffa-57f1-4d06-845e-e8c88c6d596b") |
...
| Group画面                                                                                                  | Group詳細画面                                                                                                  |
| ----------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| ![Group画面](img width="1454" alt="Image" src="https://github.com/user-attachments/assets/c3ea1a26-9b8a-4676-a9ab-89c0c2318b77") | ![Group詳細画面](img width="1448" alt="Image" src="https://github.com/user-attachments/assets/8ad842c8-d733-44f4-b643-96073cdff0e5") |
